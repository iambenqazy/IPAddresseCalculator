...
class IPOctet:
    ...
    def validate_subnetmask(self, input_subnetmask=None):
        ...
        """
        input_subnetmask_value = input_subnetmask or self.subnet_mask  # this assigns the subnet_mask if the input
        # parameter is None
    ...
    def subnetmask_cidr_to_decimal(self, subnet_value=None):
        ...
        """
        if subnet_value:
            subnet_value = self.validate_subnetmask(subnet_value)
        subnet_bit = subnet_value or self.validate_subnetmask()
    ...
    def number_of_hosts_per_network(self):
        host_bit = self.TOTAL_SUBNET_BIT - self.subnet_number_needed()
    ...
    def network_id(self):
        ...
        number_of_networks = 2 ** network_bits_needed

        range_list = list(range(0, (2**number_of_networks), range_increment))
        return range_list
    ...
    def host_id(self):
        ...
        host_ip_addresse = dict(enumerate(host_ip, 1))
        return host_ip_addresse
...
if __name__ == '__main__':
    ...
    print(f"The Input subnet is {'.'.join(map(str, ip.subnetmask_cidr_to_decimal(ip.validate_subnetmask())))}")
